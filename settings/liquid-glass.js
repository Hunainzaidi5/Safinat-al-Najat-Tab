/**
 * Safinat al-Najat Tab – Smart Dashboard - Settings UI Controller
...
function setupListeners() {
  ...
  document.getElementById('feedbackBtn').addEventListener('click', () => {
    ...
    window.location.href = `mailto:syedhunainalizaidi@gmail.com?subject=${encodeURIComponent('Safinat al-Najat Tab – Smart Dashboard Feedback')}`;
  });
}
